...
/*!
    ...
    \l QUL_PLATFORM_DEFAULT_TEXT_CACHE_ENABLED and
    \l QUL_PLATFORM_RENDER_BATCH_HEIGHT.
...
/*!
    ...
    \snippet platform_context.cpp nextUpdate
    \dots 0
    \snippet platform_context.cpp exec
...
/*!
    ...
    \snippet platform_context.cpp update

    \l Qul::Platform::PlatformContext::exec uses this function.
...
/*!
    ...
    It's main purpose is to provide platform configuration to \QUL core library.

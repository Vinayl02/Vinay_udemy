...
#define	CAN_INTERFACE_BAUDRATE	    	    250000


#if(HW_REV_VERSION == 1)
#define CLUSTER_VERSION                     "Cluster_Xavion_V6.5_22012025"
#define SOFTWARE_VERSION                    65
#define HARDWARE_VERSION                    10

#else
#define 	CLUSTER_VERSION                "Cluster_Xavion_MP_V12.20_04042025"
#define 	SOFTWARE_VERSION                1210   // 12.00
#define 	HARDWARE_VERSION                200    // 2.00
#endif


#if(UDS_SERVICE_ENABLE == 1)
#define CLUSTER_RX_CANID_MAX			 	11
#else
#define CLUSTER_RX_CANID_MAX			 	11
#endif

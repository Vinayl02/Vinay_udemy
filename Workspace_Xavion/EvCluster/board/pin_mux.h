...
/* Routed pin properties */
#define BOARD_INITLPUARTPINS_SEMC_CSX0_PERIPHERAL                        LPUART6   /*!< Peripheral name */
#define BOARD_INITLPUARTPINS_SEMC_CSX0_SIGNAL                                RXD   /*!< Signal name */

/* GPIO_EMC_B1_40 (coord K1), SEMC_RDY/U14A[C8] */
/* Routed pin properties */
#define BOARD_INITLPUARTPINS_SEMC_RDY_PERIPHERAL                         LPUART6   /*!< Peripheral name */
#define BOARD_INITLPUARTPINS_SEMC_RDY_SIGNAL                                 TXD   /*!< Signal name */
...
#define BOARD_INITMIPIPANELPINS_IOMUXC_GPR_GPR41_GPIO_MUX2_GPIO_SEL_HIGH_MASK 0x8000U /*!< GPIO2 and CM7_GPIO2 share same IO MUX function, GPIO_MUX2 selects one GPIO function: affected bits mask */
...
/* Routed pin properties */
#define BOARD_INITMIPIPANELPINS_SIM1_TRXD_PERIPHERAL                       GPIO2   /*!< Peripheral name */
#define BOARD_INITMIPIPANELPINS_SIM1_TRXD_SIGNAL                     gpio_mux_io   /*!< Signal name */
...
/* Routed pin properties */
#define BOARD_INITGPIOPINS_SIM1_PD_PERIPHERAL                              GPIO9   /*!< Peripheral name */
#define BOARD_INITGPIOPINS_SIM1_PD_SIGNAL                                gpio_io   /*!< Signal name */
#define BOARD_INITGPIOPINS_SIM1_PD_CHANNEL                                    3U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITGPIOPINS_SIM1_PD_GPIO                                    GPIO9   /*!< GPIO peripheral base pointer */
#define BOARD_INITGPIOPINS_SIM1_PD_GPIO_PIN                                   3U   /*!< GPIO pin number */
#define BOARD_INITGPIOPINS_SIM1_PD_GPIO_PIN_MASK                      (1U << 3U)   /*!< GPIO pin mask */

/* WAKEUP (coord T8), USER_BUTTON */
/* Routed pin properties */
#define BOARD_INITGPIOPINS_USER_BUTTON_PERIPHERAL                         GPIO13   /*!< Peripheral name */
#define BOARD_INITGPIOPINS_USER_BUTTON_SIGNAL                            gpio_io   /*!< Signal name */
#define BOARD_INITGPIOPINS_USER_BUTTON_CHANNEL                                0U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITGPIOPINS_USER_BUTTON_GPIO                               GPIO13   /*!< GPIO peripheral base pointer */
#define BOARD_INITGPIOPINS_USER_BUTTON_GPIO_PIN                               0U   /*!< GPIO pin number */
#define BOARD_INITGPIOPINS_USER_BUTTON_GPIO_PIN_MASK                  (1U << 0U)   /*!< GPIO pin mask */

/*!
 * @brief Configures pin routing and optionally pin electrical features.
 *
 */
void BOARD_InitGpioPins(void);                /* Function assigned for the Cortex-M7F */



void BOARD_InitFlashPins(void);              /* 4MB flash(NVM)*/
...
void BOARD_InitBacklightPins(void);
